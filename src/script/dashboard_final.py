...
if uploaded_file is not None:
    ...
    if len(colonnes_manquantes) == 0:
        ...
        # Normalisation pour certains paramètres
        ...
        df['Improvement Score'] = 0.3 * df['inverse_failures'] + 0.19 * df['inverse_goout'] + 0.15 * df['inverse_Dalc'] +0.19 * df['inverse_Walc'] + 0.24 * df['inverse_absences'] + 0.11 * df['studytime']
